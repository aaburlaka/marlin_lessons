<?
    ...
    $user = get_user_by_id(($_GET['id'] ? $_GET['id'] : $_SESSION['id']));
...
<?
    display_flash_message('edit_information_successful');
?>
                            ...
                            <div class="col-12">
                                <div class="d-flex flex-column align-items-center justify-content-center p-4">
                                    ...
                                    <div class="mt-4 text-center demo">
                                        ...
                                        <a href="https://vk.me/<?=$user['vk']?>" class="fs-xl" style="color:#4680C2">
                                            <i class="fab fa-vk"></i>
                                        </a>
