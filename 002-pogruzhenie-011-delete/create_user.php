...
<?
    display_flash_message('create_user_error');
                        ...
                        <div class="panel-container">
                            ...
                            <div class="panel-content">
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="username" type="text" id="simpleinput" class="form-control" value="<?=$_POST['username']?>">
                                </div>

                                <!-- title -->
                                <div class="form-group">
                                    <label class="form-label" for="simpleinput">Место работы</label>
                                    <input name="job_title" type="text" id="simpleinput" class="form-control" value="<?=$_POST['job_title']?>">
                                </div>

                                <!-- tel -->
                                <div class="form-group">
                                    <label class="form-label" for="simpleinput">Номер телефона</label>
                                    <input name="phone" type="text" id="simpleinput" class="form-control" value="<?=$_POST['phone']?>">
                                </div>

                                <!-- address -->
                                <div class="form-group">
                                    <label class="form-label" for="simpleinput">Адрес</label>
                                    <input name="address" type="text" id="simpleinput" class="form-control" value="<?=$_POST['address']?>">
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        ...
                                        <div class="input-group input-group-lg bg-white shadow-inset-2 mb-2">
                                            ...
                                            <input name="vk" type="text" class="form-control border-left-0 bg-transparent pl-0" value="<?=$_POST['vk']?>">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <!-- telegram -->
                                        <div class="input-group input-group-lg bg-white shadow-inset-2 mb-2">
                                            ...
                                            <input name="telegram" type="text" class="form-control border-left-0 bg-transparent pl-0" value="<?=$_POST['telegram']?>">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <!-- instagram -->
                                        <div class="input-group input-group-lg bg-white shadow-inset-2 mb-2">
                                            ...
                                            <input name="instagram" type="text" class="form-control border-left-0 bg-transparent pl-0" value="<?=$_POST['instagram']?>">
                                        </div>
                                    </div>
