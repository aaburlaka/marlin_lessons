...
?>
                                    ...
                                    <div class="dropdown-menu">
                                        ...
                                        <a href="users.php?delete=<?=$user['id']?>" class="dropdown-item" onclick="return confirm('are you sure?');">
...
<?
	...
	function has_image($user) {
		if ($user['avatar'])
			echo '<img src="'.$user['avatar'].'" alt="" class="img-responsive" width="200">';
		else
			echo '<img src="img/demo/authors/josh.png" alt="" class="img-responsive" width="200">';
